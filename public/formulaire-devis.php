...
<div class="container">
    ...
    <h1 class="mt-4 " style="color: #86C232; border-bottom: solid; border-bottom-color: #86C232">Faites votre devis</h1>
</div>
<div class="container d-flex">

    <div class="w-50 mx-auto shadow my-5  p-4 bg-gradient">
        <p class="text-danger">Veuillez mettre votre adresse de facturation</p>
